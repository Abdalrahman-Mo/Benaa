...
import { ShoppingCart, Calculator, Users, Shield, GraduationCap, Building2 } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'تسوق مواد البناء من أفضل الموردين بأسعار تنافسية مع ضمان الجودة والتوصيل السريع',
    ...
    },
    {
      ...
      description: 'احسب تكلفة مشروعك بدقة باستخدام ذكائنا الاصطناعي مع تقديرات مفصلة لكل بند',
    ...
    },
    {
      ...
      description: 'اعثر على أفضل المهندسين والفنيين المتخصصين، أو انضم كمحترف وابدأ العمل فوراً',
      image: teamImage,
    ...
    },
    {
      ...
      description: 'ضمان شامل لجودة العمل والمواد مع نظام حماية إلكتروني متقدم وتأمين كامل',
      image: warrantyImage,
    ...
    },
    {
      ...
      description: 'تعلم أحدث تقنيات البناء والتشطيب من خبراء المجال مع شهادات معتمدة',
      image: academyImage,
    ...
    },
    {
      icon: Building2,
      title: 'حلول للشركات',
      description: 'منصة متكاملة لإدارة مشاريع الشركات الكبرى مع أدوات متقدمة للمتابعة والتحكم',
      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed font-cairo">
            منصة شاملة تجمع كل ما تحتاجه لإنجاز مشروع البناء الخاص بك بأعلى جودة وأفضل الأسعار
          </p>
        </div>
            ...
            <div key={index} className="card-feature overflow-hidden group">
              ...
              <div className="relative h-48 mb-6 rounded-lg overflow-hidden">
                ...
                <div className="absolute top-4 right-4">
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${feature.color} shadow-lg`}>
