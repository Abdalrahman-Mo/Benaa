          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Tabs defaultValue="profile" className="w-full">
              <TabsList className="grid w-full grid-cols-4 mb-8">
                ...
                <TabsTrigger value="projects" className="font-cairo">مشاريعي</TabsTrigger>
                <TabsTrigger value="settings" className="font-cairo">الإعدادات</TabsTrigger>
                <TabsTrigger value="security" className="font-cairo">الأمان</TabsTrigger>
              </TabsList>
                  ...
                  <CardContent className="space-y-6">
                    <div className="flex items-center space-x-6 space-x-reverse">
                      <Avatar className="h-24 w-24">
                        ...
                        <AvatarFallback className="text-2xl font-cairo">أح</AvatarFallback>
                      </Avatar>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <Label htmlFor="firstName" className="font-cairo">الاسم الأول</Label>
                        <Input id="firstName" defaultValue="أحمد" />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="lastName" className="font-cairo">الاسم الأخير</Label>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-center py-12">
                      ...
                      <Button className="mt-4 font-cairo">ابدأ مشروع جديد</Button>
                    </div>
                  </CardContent>
                </Card>
              </TabsContent>
                  ...
                  <CardContent>
                    <div className="space-y-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="font-semibold font-cairo">إشعارات البريد الإلكتروني</p>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="font-semibold font-cairo">إشعارات الهاتف</p>
                          <p className="text-sm text-muted-foreground font-cairo">
